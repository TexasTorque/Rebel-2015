...
public class TorquePotentiometer {
    ...
    /**
     * Get the position of the potentiometer in relation to the minimum and maximum position. If you define min and max position in real units this will be in
     * real units.
     *
     * @return The position.
     */
    ...
    /**
     * Get the rate value of the potentiometer as a digital value between 0 and 4096.
     *
     * @return The value.
     */
