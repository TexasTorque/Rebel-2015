...
public class TorqueMotor {
    ...
    public TorqueMotor(Jaguar jag, boolean rev) {
        jaguar = jag;
        victor = null;
        talon = null;
        reverse = rev;
    ...
    public TorqueMotor(Victor vic, boolean rev, boolean v888) {
        jaguar = null;
        talon = null;
        victor = vic;
        reverse = rev;
    ...
    public TorqueMotor(Talon tal, boolean rev) {
        jaguar = null;
        victor = null;
        talon = tal;
    }
    ...
    private static float LimitSpeed(float speed, float limit) {
     ...
     */
    private static float LinearizeVictor(double goal_speed) {
